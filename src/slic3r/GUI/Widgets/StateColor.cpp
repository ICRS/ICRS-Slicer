...
static std::map<wxColour, wxColour> gDarkColors{
    {"#0085ff", "#0085ff"}, // rgb(0, 144, 255)    ORCA color
    ...
    {"#5476b0", "#E5E5E4"}, // rgb(50, 58, 61)     Softer text color
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#BFE1FF", "#223C3C"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity

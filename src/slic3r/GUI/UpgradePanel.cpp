...
static const wxColour TEXT_NORMAL_CLR = wxColour("#0085ff");
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0xd06500), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(0xffad54), StateColor::Hovered), std::pair<wxColour, int>(wxColour("#0085ff"), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour("#0085ff"), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour("#0085ff"), StateColor::Enabled));

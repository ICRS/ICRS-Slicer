...
static const wxColour BUTTON_HOVER_COL   = wxColour(0, 133, 255);
...
static const wxColour STAGE_TEXT_COL      = wxColour(0, 133, 255);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(0, 133, 255));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(0, 133, 255));

...
#define SELECT_ALL_OPTION_COLOUR wxColour("#0085ff")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour("#0085ff"), StateColor::Pressed), std::pair<wxColour, int>(wxColour("#0085ff"), StateColor::Hovered),
